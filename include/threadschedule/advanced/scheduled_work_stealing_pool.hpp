...
{
class scheduled_work_stealing_pool final : private ::threadschedule::detail::scheduled_pool_facade<
                                               ::threadschedule::detail::scheduled_work_stealing_pool_backend>
{
  using base
      = ::threadschedule::detail::scheduled_pool_facade<::threadschedule::detail::scheduled_work_stealing_pool_backend>;

public:
  explicit scheduled_work_stealing_pool(worker_count count = worker_count::automatic(),
