...
{
class work_stealing_pool final
    : private ::threadschedule::detail::submitting_pool_facade<::threadschedule::detail::work_stealing_pool_backend>
{
  using base = ::threadschedule::detail::submitting_pool_facade<::threadschedule::detail::work_stealing_pool_backend>;

public:
  explicit work_stealing_pool(worker_count count = worker_count::automatic(),
