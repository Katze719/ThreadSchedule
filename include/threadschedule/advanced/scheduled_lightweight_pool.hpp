...
{
class scheduled_lightweight_pool final : private ::threadschedule::detail::scheduled_pool_facade<
                                             ::threadschedule::detail::scheduled_lightweight_pool_backend>
{
  using base
      = ::threadschedule::detail::scheduled_pool_facade<::threadschedule::detail::scheduled_lightweight_pool_backend>;

public:
  explicit scheduled_lightweight_pool(worker_count count = worker_count::automatic(),
