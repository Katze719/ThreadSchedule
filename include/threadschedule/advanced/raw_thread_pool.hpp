...
{
class raw_thread_pool final
    : private ::threadschedule::detail::submitting_pool_facade<::threadschedule::detail::thread_pool_backend>
{
  using base = ::threadschedule::detail::submitting_pool_facade<::threadschedule::detail::thread_pool_backend>;

public:
  explicit raw_thread_pool(worker_count count = worker_count::automatic(),
