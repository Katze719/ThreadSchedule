...
{
class raw_scheduled_pool final
    : private ::threadschedule::detail::scheduled_pool_facade<::threadschedule::detail::scheduled_pool_backend>
{
  using base = ::threadschedule::detail::scheduled_pool_facade<::threadschedule::detail::scheduled_pool_backend>;

public:
  explicit raw_scheduled_pool(worker_count count = worker_count::automatic(),
